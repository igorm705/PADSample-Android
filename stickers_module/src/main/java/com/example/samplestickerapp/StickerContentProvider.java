...
public class StickerContentProvider extends ContentProvider {
    ...
    /**
     * Do not change the strings listed below, as these are used by WhatsApp. And changing these will break the interface between sticker stickers_module and WhatsApp.
     */
    ...
    public static final Uri AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority("com.example.standartstickersapp.stickercontentprovider").appendPath(StickerContentProvider.METADATA).build();
