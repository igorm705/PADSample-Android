...
public class StickerPackListAdapter extends RecyclerView.Adapter<StickerPackListItemViewHolder> {
    ...
    StickerPackListAdapter(@NonNull List<StickerPack> stickerPacks,
        ...
        Log.i("RecyclerView", "class StickerPackListAdapter, " +
                "  StickerPackListAdapter(@NonNull List<StickerPack> stickerPacks, \n" +
                "                           @NonNull OnAddButtonClickedListener onAddButtonClickedListener)   ");
    ...
    public StickerPackListItemViewHolder onCreateViewHolder(@NonNull final ViewGroup viewGroup, final int i) {
        ...
        Log.i("RecyclerView", "class StickerPackListAdapter, " +
                " public StickerPackListItemViewHolder onCreateViewHolder(@NonNull final ViewGroup viewGroup, " +
                "final int i)  ");
    ...
    public void onBindViewHolder(@NonNull final StickerPackListItemViewHolder viewHolder, final int index) {
        ...
        for (int i = 0; i < actualNumberOfStickersToShow; i++) {
            ...
            LayoutInflater.from(context).inflate(R.layout.sticker_packs_list_image_item, viewHolder.imageRowView, false);
           ...
           String temp = MainActivity.getAssetsFolderPath(pack.identifier, pack.getStickers().get(i).imageFileName);
            rowImage.setImageURI(Uri.fromFile(new File(temp)));
