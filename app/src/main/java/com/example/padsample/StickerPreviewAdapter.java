...
public class StickerPreviewAdapter extends RecyclerView.Adapter<StickerPreviewViewHolder> {
    ...
    StickerPreviewAdapter(
        ...
        Log.i("RecyclerView", "class StickerPreviewAdapter, " +
                " StickerPreviewAdapter(\n" +
                "            @NonNull final LayoutInflater layoutInflater,\n" +
                "            final int errorResource,\n" +
                "            final int cellSize,\n" +
    ...
    public void onBindViewHolder(@NonNull final StickerPreviewViewHolder stickerPreviewViewHolder, final int i) {
        ...
        String temp = MainActivity.getAssetsFolderPath(stickerPack.identifier, stickerPack.getStickers().get(i).imageFileName);

        stickerPreviewViewHolder.stickerPreviewView.setImageURI(Uri.fromFile(new File(temp)));
       //stickerPreviewViewHolder.stickerPreviewView.setImageURI(StickerPackLoader.getStickerAssetUri(stickerPack.identifier, stickerPack.getStickers().get(i).imageFileName));
        ...
        Log.i("RecyclerView", "class StickerPreviewAdapter, " +
                " public void onBindViewHolder(@NonNull final StickerPreviewViewHolder " +
                "stickerPreviewViewHolder, final int i)  ");
    }
    ...
    private void expandPreview(int position, View clickedStickerPreview) {
        ...
        //    final Uri stickerAssetUri = StickerPackLoader.getStickerAssetUri(stickerPack.identifier, stickerPack.getStickers().get(position).imageFileName);
           String stickerAssetPath = MainActivity.getAssetsFolderPath(stickerPack.identifier, stickerPack.getStickers().get(position).imageFileName);
//            uri = Uri.fromFile(new File(stickerAssetPath));

            DraweeController controller = Fresco.newDraweeControllerBuilder()
                    .setUri(Uri.fromFile(new File(stickerAssetPath)))
