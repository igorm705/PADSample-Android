...
public abstract class AddStickerPackActivity extends BaseActivity {
    ...
    private static final String TAG1 = "RecyclerView";
    ...
    protected void addStickerPackToWhatsApp(String identifier, String stickerPackName) {
        try {
            ...
            if (!stickerPackWhitelistedInWhatsAppConsumer && !stickerPackWhitelistedInWhatsAppSmb) {
                //ask users which stickers_module to add the pack to.
    ...
    //Handle cases either of WhatsApp are set as default stickers_module to handle this intent. We still want users to see both options.
