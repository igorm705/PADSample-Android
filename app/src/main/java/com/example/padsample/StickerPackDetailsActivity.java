...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("RecyclerView", "class StickerPackDetailsActivity, " +
                " protected void onCreate(Bundle savedInstanceState)");
        ...
        String temp = MainActivity.getAssetsFolderPath(stickerPack.identifier, stickerPack.trayImageFile);

        packTrayIcon.setImageURI(uri.fromFile(new File(temp)));
    ...
    private void launchInfoActivity(String publisherWebsite,
                                    String publisherEmail, String privacyPolicyWebsite,
                                    String licenseAgreementWebsite, String trayIconUriString) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //    Uri trayIconUri = StickerPackLoader.getStickerAssetUri(stickerPack.identifier, stickerPack.trayImageFile);
           String trayIconUri = MainActivity.getAssetsFolderPath(stickerPack.identifier, stickerPack.trayImageFile);
            launchInfoActivity(stickerPack.publisherWebsite, stickerPack.publisherEmail, stickerPack.privacyPolicyWebsite, stickerPack.licenseAgreementWebsite, trayIconUri);
            return true;
        }
